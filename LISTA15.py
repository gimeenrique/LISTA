...
def cantidad_pokemons(entrenador):
    ...
    return 0
print ("---------------------------------------------------------------------------------------------------")
print("Cantidad de Pokémons de Gimena:", cantidad_pokemons("Gimena"))
...
def entrenador_pokemons(entrenador):
    ...
    return None
print("Datos de Santiago y sus Pokémons:", entrenador_pokemons("Santiago"))
print ("---------------------------------------------------------------------------------------------------")
...
resultado = entrenador_tiene_pokemon("Gimena", "Pidgeotto")
if resultado:
    entrenador, pokemon = resultado
    print("k. Gimena tiene a 'Pidgeotto':")
    ...
    print("k. Gimena no tiene a 'Pidgeotto'.")
